...
export default function FlowZoneDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {venueInfo && <Header venue={venueInfo} isLive={isLive} zones={zones} />}
      ...
      <main id="main-content" className="container mx-auto px-4 py-6">
        ...
        {hasError && (
          <Alert variant="destructive" className="mb-6">
            ...
            <AlertDescription>
              {zonesError || venueError}. Using cached data if available.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="flex flex-col gap-6 mb-8">
          ...
          {/* Stats Bar and Map Preview Row */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              <StatsBar stats={stats} isLoading={statsLoading} />
            </div>
            <div className="md:col-span-1">
              <MapPreviewCard zones={zones} />
            </div>
          </div>
        </div>
